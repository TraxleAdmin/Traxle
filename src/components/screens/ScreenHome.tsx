...
export default function ScreenHome() {
  // Wallet ekranındaki gibi canlılık hissi için bildirimi sonradan gösteriyoruz
  const [showNotification, setShowNotification] = useState(false);

  useEffect(() => {
    const timer = setTimeout(() => {
      setShowNotification(true);
    }, 1500); // 1.5 saniye sonra bildirim düşer
    ...
    <div className="flex flex-col h-full p-5 space-y-4 pt-10 transition-colors duration-300 bg-gray-50 dark:bg-[#050814]">
      ...
      >
          ...
          <div className="flex justify-between items-start mb-3 relative z-10">
             ...
             <span className="text-gray-900 dark:text-white font-bold text-lg">€3.250</span>
          </div>
          ...
          <div className="flex justify-between items-center text-xs relative z-10 text-gray-600 dark:text-gray-300 mb-4">
              ...
              <span className="font-semibold">Münih</span>
          </div>
          ...
          <div className="flex items-center gap-2">
              ...
              <p className="text-[10px] font-bold text-green-600 dark:text-green-500">Yüklemeye Hazır</p>
          </div>
      </motion.div>
        ...
        {showNotification && (
          ...
          >
            <div className="flex items-center gap-3">
               ...
               <div>
                 <p className="text-[10px] font-bold text-gray-900 dark:text-white">Yeni Teklif Var</p>
                 <p className="text-[9px] text-gray-500">Ankara lojistik üssünden...</p>
               </div>
            </div>
          </motion.div>
        )}
