...
export default function ScreenMap() {
    // Rota Temsili (Makinenin Lowbed ile Şantiyeye gidişi)
            ...
            <div className="relative z-30 pt-6 px-4">
                <div className="bg-[#1A1F36]/90 backdrop-blur-xl border border-white/10 p-4 rounded-3xl flex items-center gap-4 shadow-2xl">
                    ...
                    <div className="flex-1 min-w-0">
                        <h3 className="font-bold text-white text-sm truncate">Döşemealtı Şantiyesi</h3>
                        <div className="flex items-center gap-2 mt-0.5">
                            <span className="text-green-400 text-xs font-bold">Tahmini: 45dk</span>
                            <span className="text-gray-500 text-xs">•</span>
                            <span className="text-gray-400 text-xs">25 km kaldı</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="absolute bottom-6 left-4 right-4 z-30">
                <div className="flex gap-3">
                    <div className="bg-[#1A1F36]/90 backdrop-blur-xl border border-white/10 p-3 rounded-2xl flex-1 shadow-lg">
                        <p className="text-[10px] text-gray-400 uppercase tracking-wider mb-1">Araç Tipi</p>
                        <div className="flex items-baseline gap-1">
                            <span className="text-sm font-black text-white">Lowbed</span>
                        </div>
                    </div>
                    <div className="bg-[#1A1F36]/90 backdrop-blur-xl border border-white/10 p-3 rounded-2xl flex-1 shadow-lg">
                        <p className="text-[10px] text-gray-400 uppercase tracking-wider mb-1">Durum</p>
                        <div className="flex items-baseline gap-1">
                            <span className="text-sm font-black text-green-400 animate-pulse">Yolda</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-4 flex justify-center">
                    <div className="bg-black/40 backdrop-blur-sm px-3 py-1 rounded-full border border-white/5 flex items-center gap-2">
                        ...
                        <p className="text-[10px] text-gray-400">Canlı GPS Takibi Aktif</p>
                    </div>
                </div>
            </div>
