    ...
    <div className="max-w-none space-y-8">
      ...
      <div className="bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm">
        ...
        <div className="p-5 border border-blue-100 dark:border-blue-500/20 rounded-2xl bg-blue-50/50 dark:bg-blue-900/10 flex gap-4 items-start">
            ...
            <div className="text-sm text-gray-700 dark:text-gray-300">
                <p className="m-0 mb-2 font-bold">Traxle, kullanıcıları birbirleriyle buluşturan aracı bir dijital platformdur.</p>
                <ul className="list-disc pl-5 m-0 space-y-1">
                    <li>TRAXLE; Taşımanın fiili icracısı değildir,</li>
                    <li>Nakliyeci veya taşıma organizatörü sıfatı taşımaz,</li>
      ...
      <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm">
            ...
            <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                <li className="flex items-center gap-2"><FiCheckCircle className="text-green-500"/> İlan oluşturma</li>
                <li className="flex items-center gap-2"><FiCheckCircle className="text-green-500"/> Eşleşme sağlama</li>
                <li className="flex items-center gap-2"><FiCheckCircle className="text-green-500"/> Süreç takibi</li>
                <li className="flex items-center gap-2"><FiCheckCircle className="text-green-500"/> Ödeme aracılığı</li>
            </ul>
          ...
          <div className="bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm">
            ...
            <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-2">
                ...
                <li>Hukuka uygun hareket etmek</li>
      ...
      <div className="bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-500/20 rounded-3xl p-8 backdrop-blur-sm">
        ...
        <div className="grid md:grid-cols-2 gap-x-4 gap-y-2 text-sm text-red-800 dark:text-red-200">
            <div className="flex items-center gap-2"><FiXCircle/> Platform’u baypas ederek komisyon dışı işlem yapmak</div>
            <div className="flex items-center gap-2"><FiXCircle/> Sahte hesap ve işlem oluşturmak</div>
            ...
            <div className="flex items-center gap-2"><FiXCircle/> Haksız chargeback</div>
            <div className="flex items-center gap-2 md:col-span-2"><FiXCircle/> Güvenliği bozacak eylemler</div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm">
            ...
            <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-2">
                <li>Ücretler işlem öncesi açıkça gösterilir.</li>
                <li>Ödemeler <strong>iyzico</strong> altyapısı ile alınır.</li>
                <li>Kart verileri TRAXLE tarafından saklanmaz.</li>
            </ul>
          </div>
          ...
          <div className="bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm">
            ...
            <div className="flex gap-3 items-start p-3 border border-blue-100 dark:border-blue-500/20 rounded-xl bg-blue-50/50 dark:bg-blue-900/10">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300 m-0">
                    Ücretli hizmetler, ödeme onayıyla derhal başlar. Kullanıcı bu durumu bilerek işlem yapar.
                </p>
            </div>
          </div>
      </div>
      ...
      <div className="bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm">
        ...
        <div className="grid md:grid-cols-3 gap-4 text-sm text-gray-700 dark:text-gray-300">
            <div className="p-3 border border-gray-100 dark:border-white/10 rounded-xl bg-white/40 dark:bg-white/[0.02]">
                <strong>Abonelik:</strong> Panelden iptal edilebilir.
            </div>
            <div className="p-3 border border-gray-100 dark:border-white/10 rounded-xl bg-white/40 dark:bg-white/[0.02]">
                <strong>İlan:</strong> Ekranda gösterilen kurallar geçerlidir.
            </div>
            <div className="p-3 border border-gray-100 dark:border-white/10 rounded-xl bg-white/40 dark:bg-white/[0.02]">
                <strong>Kötüye Kullanım:</strong> İade reddedilebilir.
            </div>
        </div>
      </div>
      ...
      <div className="bg-orange-50 dark:bg-orange-900/10 border border-orange-100 dark:border-orange-500/20 rounded-3xl p-8 backdrop-blur-sm">
        ...
        <ul className="list-disc pl-5 text-sm text-orange-800 dark:text-orange-200 space-y-1 mb-3">
            <li>Taşımanın ifasından,</li>
            <li>Yükün hasar/kaybından,</li>
            <li>Taraflar arası uyuşmazlıktan.</li>
        </ul>
        <p className="text-sm font-bold text-orange-800 dark:text-orange-200 m-0">Sorumluluk tahsil edilen komisyonla sınırlıdır.</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-4">
          <div className="p-5 border border-gray-100 dark:border-white/10 rounded-2xl bg-white/50 dark:bg-white/5">
             ...
             <p className="text-xs text-gray-600 dark:text-gray-400 m-0">Platform’daki yazılım, tasarım ve markalar TRAXLE’a aittir. Kullanıcıya yalnızca kullanım hakkı verilir.</p>
          </div>
          <div className="p-5 border border-gray-100 dark:border-white/10 rounded-2xl bg-white/50 dark:bg-white/5">
             <div className="flex items-center gap-2 font-bold text-gray-900 dark:text-white mb-2"><FiFileText/> Kişisel Veriler</div>
             <p className="text-xs text-gray-600 dark:text-gray-400 m-0">Veriler Gizlilik Politikası ve KVKK metni kapsamında işlenir.</p>
          </div>
          <div className="p-5 border border-gray-100 dark:border-white/10 rounded-2xl bg-white/50 dark:bg-white/5">
             <div className="flex items-center gap-2 font-bold text-gray-900 dark:text-white mb-2"><FiLock/> Güvenlik</div>
             <p className="text-xs text-gray-600 dark:text-gray-400 m-0">Platform güvenliği için log tutulabilir. TRAXLE güvenlik şüphesinde hesabı askıya alabilir.</p>
          </div>
      </div>
      ...
      <div className="bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm">
        <div className="grid md:grid-cols-3 gap-6">
            <div>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">İnternet kesintisi, üçüncü taraf arızaları, resmi kararlar gibi hallerde TRAXLE sorumlu değildir.</p>
            </div>
            <div>
                <h4 className="font-bold text-gray-900 dark:text-white text-sm mb-2 flex items-center gap-2"><FiRefreshCw/> Değişiklik</h4>
                <p className="text-xs text-gray-600 dark:text-gray-400">Bu koşullar güncellenebilir; yayımlandığı tarihte yürürlüğe girer.</p>
            </div>
            <div>
                <h4 className="font-bold text-gray-900 dark:text-white text-sm mb-2 flex items-center gap-2"><FiShield/> Delil ve Yetki</h4>
                <p className="text-xs text-gray-600 dark:text-gray-400">Platform kayıtları delil kabul edilir. Yetkili mahkeme Antalya’dır.</p>
            </div>
        </div>
      </div>
