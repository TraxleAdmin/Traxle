        ...
        <div className="max-w-none space-y-8">
                ...
                <div className="p-6 border border-indigo-200 dark:border-indigo-500/30 rounded-2xl bg-indigo-50/50 dark:bg-indigo-900/10 relative overflow-hidden">
                    <div className="grid md:grid-cols-2 gap-x-8 gap-y-4">
                        <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-200 list-none pl-0">
                            ...
                            <li className="flex flex-col"><span className="text-xs font-bold text-indigo-700 dark:text-indigo-400 uppercase">Ödeme Kuruluşu</span> <span>BDDK Lisanslı Ödeme Kuruluşları</span></li>
                        </ul>
                        <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-200 list-none pl-0">
            ...
            <div className="bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
                    Traxle, şantiyeleri ve makine sahiplerini bir araya getiren aracı bir dijital ilan ve eşleşme platformudur. Platform üzerinden şu hizmetler sunulur:
                </p>
                <ul className="grid md:grid-cols-2 gap-2 text-sm text-gray-700 dark:text-gray-300 mb-4">
                    <li className="flex items-center gap-2"><FiLayers className="text-indigo-500" /> İş makinesi kiralama ilanı oluşturma</li>
                    <li className="flex items-center gap-2"><FiLayers className="text-indigo-500" /> Tedarikçi (Makine Sahibi) eşleştirme</li>
                    <li className="flex items-center gap-2"><FiLayers className="text-indigo-500" /> İlan öne çıkarma (Doping) hizmetleri</li>
                    <li className="flex items-center gap-2"><FiLayers className="text-indigo-500" /> Güvenli Havuz (Ödeme aracılığı) sistemi</li>
                </ul>
                <div className="p-3 bg-indigo-50 dark:bg-indigo-900/10 border border-indigo-100 dark:border-indigo-500/20 rounded-xl text-sm text-indigo-800 dark:text-indigo-200">
                    <strong>NOT:</strong> TRAXLE, kiralama operasyonunun fiili icracısı değildir; kiralama sözleşmesi doğrudan Şantiye (Hizmet Alan) ile Makine Sahibi (Hizmet Veren) arasında kurulur.
                </div>
            </div>
            ...
            <div className="bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm">
                ...
                <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300 space-y-2 marker:text-indigo-500">
                    <li>Abonelik ücretleri ve ek özellik (Doping) bedelleri satın alma ekranında açıkça gösterilir.</li>
                    <li>Tüm vergiler dahil toplam bedel kullanıcı onayına sunulur.</li>
                    <li>Traxle kiralama bedeli üzerinden komisyon kesintisi yapmaz.</li>
                    <li>Ödemeler BDDK lisanslı ödeme kuruluşları ile tahsil edilir, kart bilgileri TRAXLE tarafından saklanmaz.</li>
                </ul>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm">
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="text-sm text-gray-700 dark:text-gray-300 space-y-1">
                            ...
                            <p className="m-0">Abonelik veya Doping kapsamında platform özelliklerine anında erişim sağlanır.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-orange-50 dark:bg-orange-900/10 border border-orange-100 dark:border-orange-500/20 rounded-3xl p-8 backdrop-blur-sm">
                    ...
                    <p className="text-sm text-orange-800 dark:text-orange-200 mb-2">
                        Dijital hizmetin kullanıcı onayıyla derhal ifa edilmesi nedeniyle, mevzuattaki cayma hakkı istisnaları uygulanır. Kullanıcı satın alma adımında;
                    </p>
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <div className="grid md:grid-cols-2 gap-3 text-sm text-gray-700 dark:text-gray-300">
                            <div className="p-3 border border-gray-100 dark:border-white/10 rounded-xl bg-white/40 dark:bg-white/[0.02]">
                                <strong>Abonelik:</strong> Panel üzerinden iptal edilebilir; iptal sonraki dönemin yenilemesini durdurur. Mevcut dönem sonuna kadar erişim devam eder.
                            </div>
                            <div className="p-3 border border-gray-100 dark:border-white/10 rounded-xl bg-white/40 dark:bg-white/[0.02]">
                                <strong>Kötüye Kullanım:</strong> Platform kurallarının ihlali halinde ücret iadesi yapılmaksızın hesap dondurulabilir.
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-700 dark:text-gray-300 m-0">
                            TRAXLE, aracı platformdur; kiralama sürecindeki aksaklıklardan, hasarlardan veya taraflar arası uyuşmazlıklardan sorumlu tutulamaz. Platformun sorumluluğu kullanıcının ödediği (varsa) abonelik/doping bedeli ile sınırlıdır.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm">
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400">Platform kayıtları ve elektronik loglar yasal delil niteliğindedir.</p>
                    </div>
                    <div>
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400">Kullanıcı, bu Ön Bilgilendirme Formu’nu okuyarak anladığını ve Mesafeli Hizmet Sözleşmesi ile birlikte elektronik ortamda kabul ettiğini beyan eder.</p>
                    </div>
                </div>
            </div>
