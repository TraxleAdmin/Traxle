...
export const LOCALE_META: Record<Locale, LocaleMeta> = {
  tr: { code: "tr", nativeLabel: "Turkce", englishLabel: "Turkish", flag: "TR", dir: "ltr" },
  ...
  ru: { code: "ru", nativeLabel: "Russkiy", englishLabel: "Russian", flag: "RU", dir: "ltr" },
  ar: { code: "ar", nativeLabel: "Al-Arabiyya", englishLabel: "Arabic", flag: "SA", dir: "rtl" },
};
...
export const ROUTE_SLUGS: Record<RouteKey, Record<Locale, string[]>> = {
  ...
  preInfo: {
    ...
    ar: ["namudhaj-aliikhbar-almusbaq"],
  },
  molatik: {
    tr: ["products", "molatik"],
    en: ["products", "molatik"],
