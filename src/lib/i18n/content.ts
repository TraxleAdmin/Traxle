  ...
  tr: {
    ...
    home: {
      ...
      cards: [
        ...
        },
        {
          ...
          description: "Yük eşleştirme, teslimat takip ve maliyet raporlamayı birleştirir.",
    ...
    about: {
      ...
      stats: [
        ...
        { label: "Aylık İşlenen Kayıt", value: COMMON_STATS.records },
        { label: "Platform Uptime", value: COMMON_STATS.uptime },
      ],
      sections: [
        {
          title: "Ne yapıyoruz?",
          body: "Dijital kimlik, işgücü yönetimi ve lojistik operasyonları tek ekosistemde birleştiren modüller tasarlıyoruz.",
        },
        {
    ...
    products: {
      ...
      kunyex: {
        ...
        highlights: [
          ...
          "Denetlenebilir audit kayıtları",
        ],
      ...
      logistics: {
        ...
        intro:
          "Traxle Logistics, yük eşleştirme ve sevkiyat akışını veri odaklı hale getirir.",
        highlights: [
    ...
    productPrivacy: {
      ...
      kunyex: {
        ...
        intro:
          "Bu metin KunyeX ürünündeki dijital kimlik verisi, lisanslama ve audit süreçlerini kapsar.",
        sections: [
    ...
    pages: {
      features: {
        ...
        sections: [
          ...
          { title: "Kurumsal uyum", body: "Yetki ve log politikalarını merkezi olarak uygular." },
        ],
      },
      pricing: {
        title: "Fiyatlandırma",
      ...
      integrations: {
        ...
        sections: [
          ...
          { title: "BI aktarımı", body: "Planlı export ile analitik sistemlere veri akışı." },
        ],
      },
      contact: {
        title: "İletişim",
      ...
      careers: {
        ...
        sections: [
          ...
          { title: "Çalışma şekli", body: "Role göre hibrit ve uzaktan çalışma imkanı." },
          { title: "Açık roller", body: "Mühendislik, ürün ve operasyon pozisyonları sürekli açıktır." },
        ],
      },
      updates: {
        title: "Ürün Güncellemeleri",
        intro: "Sürüm notları, güvenlik iyileştirmeleri ve roadmap özeti bu sayfada yayınlanır.",
        sections: [
          { title: "Son sürüm", body: "Performans ve dashboard iyileştirmeleri yayına alındı." },
          { title: "Güvenlik", body: "Oturum güvenliği ve audit alarm kuralları güncellendi." },
