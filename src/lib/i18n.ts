...
export const dictionaries: Record<Locale, Dictionary> = {
  tr: {
    ...
    home: {
      eyebrow: 'Traxle ekosistemi',
      title: 'Traxle operasyon teknolojileri',
      description:
        'Biz Traxle’ız. BarkodX, Molatik, KünyeX ve lojistik katmanlarını; okunabilir, ölçülebilir ve güvenilir iş akışları için aynı teknoloji omurgasında buluşturuyoruz.',
      primaryCta: 'Ekosistemi İncele',
      secondaryCta: 'Demo Talep Et',
      proof: ['Tek marka altında ürün ailesi', 'Operasyon verisine uygun mimari', 'Web ve masaüstü sürekliliği'],
      productsTitle: 'Traxle ürün ekosistemi',
      productsDescription: 'Her ürün kendi iş akışını çözer; tamamı Traxle’ın aynı tasarım ve mühendislik standardıyla ilerler.',
      howTitle: 'Ürün değil, sürdürülebilir operasyon katmanı',
      howDescription: 'Traxle, günlük iş süreçlerini ayrı ayrı parlatmak yerine aynı veri diliyle birbirine bağlayan yazılım katmanları geliştirir.',
      howSteps: [
        {
          title: 'Traxle standardını belirle',
          description: 'Stok, personel, belge ve saha akışlarını aynı kalite çizgisinde ele alan ürün yapısını kurar.',
        },
        {
          title: 'Veriyi okunabilir hale getir',
          description: 'Her ürün, kendi operasyon verisini daha temiz, takip edilebilir ve karar almaya hazır biçime taşır.',
        },
        {
          title: 'Ekosistemi birlikte büyüt',
          description: 'BarkodX, Molatik, KünyeX ve Lojistik aynı Traxle çatısı altında yeni iş ihtiyaçlarına göre genişler.',
        },
      ],
      demoTitle: 'Traxle ekosistemini işletmene uyarlayalım',
      demoDescription:
        'Operasyon yapını birlikte okuyup Traxle ürün ailesinin hangi katmanlarının işine değer katacağını netleştirelim.',
      demoLabel: 'Demo Talep Et',
    },
    projects: {
      eyebrow: 'Traxle ekosistemi',
      title: 'Traxle’ın geliştirdiği operasyon katmanları.',
      description: 'BarkodX, Molatik, KünyeX ve Lojistik; aynı teknoloji omurgasından çıkan, farklı iş akışlarını tamamlayan ürün katmanlarıdır.',
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Traxle marka dilini ve ürün ekosistemini tutarlı anlatan okunabilir dijital deneyimler.',
        },
      ],
    },
    contact: {
    ...
    cta: {
      title: 'Traxle ekosistemini işletmende görmek ister misin?',
      description:
        'BarkodX, Molatik, KünyeX ve Lojistik katmanlarından hangilerinin operasyonuna uyacağını birlikte değerlendirelim.',
      label: 'Demo Talep Et',
    },
    privacy: {
    ...
    footer: {
      description: 'Barkod, mola, belge ve lojistik operasyonlarını aynı Traxle mühendislik diliyle buluşturan yazılım ekosistemi.',
  ...
  en: {
    ...
    home: {
      eyebrow: 'Traxle ecosystem',
      title: 'Traxle operations technology',
      description: 'BarkodX, Molatik, KünyeX, and Logistics run as product layers on the same Traxle technology spine.',
      primaryCta: 'Explore Ecosystem',
      secondaryCta: 'Request Demo',
      proof: ['One product family', 'Operations-first architecture', 'Web and desktop continuity'],
      productsTitle: 'Traxle product ecosystem',
      productsDescription: 'Each product solves its own workflow, all shaped by the same Traxle design and engineering standard.',
      ...
      demoTitle: 'Let’s adapt the Traxle ecosystem to your business',
      demoDescription:
        'Let’s read your operation and decide which Traxle product layers create the strongest value.',
      demoLabel: 'Request Demo',
    },
    projects: {
      eyebrow: 'Traxle ecosystem',
      title: 'Operations layers developed by Traxle.',
      description: 'BarkodX, Molatik, KünyeX, and Logistics are product layers built on the same technology spine for different workflows.',
