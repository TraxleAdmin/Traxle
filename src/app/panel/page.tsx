...
import { FiSmartphone, FiShield, FiZap, FiArrowRight } from 'react-icons/fi';
...
export default function PanelHome() {
  ...
  // Kullanıcı Durumunu ve Verisini Çek
  useEffect(() => {
  ...
  const firstName = userData?.name?.split(' ')[0] || user?.email?.split('@')[0] || 'Kullanıcı';
      ...
      >
        ...
        <div className="relative z-10">
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
              Güvenliğiniz ve operasyonel hızınız için yük oluşturma, cüzdan yönetimi ve harita takibi işlemleri sadece <strong>Traxle Mobil Uygulaması</strong> üzerinden yapılmaktadır.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto mb-12 text-left">
                <div className="bg-gray-50 dark:bg-white/5 p-5 rounded-2xl border border-gray-100 dark:border-white/5 flex items-start gap-4">
                    ...
                    <div>
                        <h4 className="font-bold text-gray-900 dark:text-white">Yüksek Güvenlik</h4>
                        <p className="text-xs text-gray-500 mt-1">Sistemimiz, sahte işlemleri önlemek için sadece mobil cihaz donanım kimlikleriyle çalışır.</p>
                    </div>
                </div>
                <div className="bg-gray-50 dark:bg-white/5 p-5 rounded-2xl border border-gray-100 dark:border-white/5 flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">Yeni yükler ve ödemeler telefonunuza anında (Push Notification) olarak düşer.</p>
                    </div>
                </div>
            </div>
