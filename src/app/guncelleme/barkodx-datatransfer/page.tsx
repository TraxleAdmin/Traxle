    ...
    <div className="relative min-h-screen overflow-hidden bg-gray-50 px-4 pb-20 pt-28 text-gray-900 transition-colors dark:bg-[#050814] dark:text-white">
      ...
      <div className="relative mx-auto w-full max-w-6xl">
        <span className="inline-flex rounded-full border border-cyan-200 bg-cyan-50 px-4 py-1 text-xs font-bold uppercase tracking-wider text-cyan-700 dark:border-cyan-500/30 dark:bg-cyan-500/10 dark:text-cyan-300">
          BarkodX Veri Aktarımı
        </span>

        <h1 className="mt-5 text-4xl font-black tracking-tight sm:text-5xl">BarkodX veri taşıma merkezi</h1>
        <p className="mt-4 max-w-3xl text-base leading-7 text-gray-600 dark:text-gray-300">
          BarkodX kullanan ekipler için veri taşıma öncesi hazırlık, aktarım ve doğrulama adımları bu sayfada toplandı.
          Süreçte hata riskini azaltmak için kontrol listesini adım adım uygulayın.
        </p>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <article className="rounded-3xl border border-gray-200/80 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl dark:border-white/10 dark:bg-white/[0.04]">
            <p className="text-xs font-bold uppercase tracking-wide text-cyan-700 dark:text-cyan-300">Aktarım öncesi</p>
            <h2 className="mt-2 text-xl font-black">Hazırlık kontrol kartı</h2>
          ...
          <article className="rounded-3xl border border-gray-200/80 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl dark:border-white/10 dark:bg-white/[0.04]">
            <p className="text-xs font-bold uppercase tracking-wide text-blue-700 dark:text-blue-300">Aktarım sonrası</p>
            <h2 className="mt-2 text-xl font-black">Doğrulama kontrol kartı</h2>
            <ul className="mt-4 space-y-3 text-sm leading-7 text-gray-600 dark:text-gray-300">
              <li className="inline-flex gap-2">
        ...
        <section className="mt-8 rounded-3xl border border-gray-200/80 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/[0.04]">
          <h3 className="inline-flex items-center gap-2 text-lg font-black">
            ...
            İndirme ve yönlendirme
          </h3>
          <p className="mt-3 text-sm leading-7 text-gray-600 dark:text-gray-300">
            Yeni cihaz kurulumunda BarkodX iOS uygulamasını resmi App Store bağlantısından indirin. Güncelleme dosyaları
            ve masaüstü dağıtımları için KunyeX sayfasına geçiş yapabilirsiniz.
          </p>
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            >
              KunyeX güncelleme sayfasına geç
              <FiArrowUpRight />
            </Link>
          </div>
        </section>
