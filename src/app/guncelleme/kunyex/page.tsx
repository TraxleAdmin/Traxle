  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gray-50 px-4 pb-20 pt-28 text-gray-900 transition-colors dark:bg-[#050814] dark:text-white">
      ...
      <div className="relative mx-auto w-full max-w-6xl">
        ...
        <h1 className="mt-5 text-4xl font-black tracking-tight sm:text-5xl">KunyeX istemci güncelleme paketi</h1>
        <p className="mt-4 max-w-3xl text-base leading-7 text-gray-600 dark:text-gray-300">
          Bu sayfa, saha ve merkez ekipleri için kontrollü güncelleme dağıtımı amacıyla hazırlanmıştır.
          Uygulama sürüm bildirim dosyasını okuyarak sürümü doğrulayabilir, EXE paketi ile manuel kurulum yapabilirsiniz.
        </p>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <article className="rounded-3xl border border-gray-200/80 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl dark:border-white/10 dark:bg-white/[0.04]">
            <p className="text-xs font-bold uppercase tracking-wide text-indigo-700 dark:text-indigo-300">Sürüm kaynağı</p>
            <h2 className="mt-2 text-xl font-black">1) Güncelleme sürüm bildirimi</h2>
            <p className="mt-3 text-sm leading-7 text-gray-600 dark:text-gray-300">Masaüstü istemci, yeni sürüm kontrolü için aşağıdaki JSON dosyasını okur:</p>
            <code className="mt-3 block rounded-xl bg-gray-100 p-3 text-xs text-gray-800 dark:bg-white/10 dark:text-gray-100">{MANIFEST_URL}</code>
            <Link
              href={MANIFEST_URL}
              target="_blank"
              rel="noreferrer"
          ...
          <article className="rounded-3xl border border-gray-200/80 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl dark:border-white/10 dark:bg-white/[0.04]">
            <p className="text-xs font-bold uppercase tracking-wide text-blue-700 dark:text-blue-300">Kurulum paketi</p>
            <h2 className="mt-2 text-xl font-black">2) Manuel kurulum dosyası</h2>
            <p className="mt-3 text-sm leading-7 text-gray-600 dark:text-gray-300">İstemcinin indireceği resmi güncelleme EXE dosyası:</p>
            <code className="mt-3 block rounded-xl bg-gray-100 p-3 text-xs text-gray-800 dark:bg-white/10 dark:text-gray-100">{EXE_URL}</code>
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              >
                <FiRefreshCw />
                BarkodX uygulama güncelleme sayfası
              </Link>
            </div>
          </article>
        </div>
        ...
        <section className="mt-8 rounded-3xl border border-gray-200/80 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/[0.04]">
          ...
          <ol className="mt-4 list-decimal space-y-2 pl-5 text-sm leading-7 text-gray-600 dark:text-gray-300">
            <li>Mevcut kurulum dizininin yedeğini alın.</li>
            <li>JSON sürüm bildirimi ile sürüm bilgisini doğrulayın.</li>
            <li>EXE dosyasını indirip yönetici yetkisiyle çalıştırın.</li>
            <li>Kurulum sonrası giriş, profil ve senkronizasyon kontrollerini tamamlayın.</li>
          </ol>
          <div className="mt-5">
            <Link
              href="/guncelleme"
