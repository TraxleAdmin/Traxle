...
export default function BarkodxApplicationsUpdatePage() {
  return (
    <div className="min-h-screen bg-gray-50 px-4 pt-28 pb-20 text-gray-900 transition-colors dark:bg-[#050814] dark:text-white">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          ...
          <article className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/[0.04]">
            ...
            <Link
              ...
              className="mt-5 inline-flex rounded-full border border-blue-300 bg-blue-50 px-5 py-3 text-sm font-semibold text-blue-800 transition hover:border-blue-400 dark:border-blue-400/40 dark:bg-blue-400/10 dark:text-blue-200"
            >
          ...
          <article className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/[0.04]">
            ...
            <div className="mt-5 flex flex-col gap-2">
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-900 transition hover:border-gray-400 dark:border-white/20 dark:bg-white/10 dark:text-white dark:hover:border-white/40"
              >
                kunyex-latest.json
              </Link>
              <Link
                href={KUNYEX_EXE_URL}
                className="inline-flex rounded-full bg-purple-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-purple-700"
              >
        ...
        <section className="mt-8 rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/[0.04]">
          <h3 className="text-lg font-black">Operasyon notlari</h3>
